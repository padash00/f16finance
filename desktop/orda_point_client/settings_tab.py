    ...
    def __init__(self, title: str, icon: str, parent=None):
        ...
        separator.setStyleSheet("""
            ...
            background: qlineargradient(x1:0, y1:0, x2:1, y2:0,
                stop:0 transparent, stop:0.5 #1E2A3A, stop:1 transparent);
            max-height: 1px;
        """)
...
class ValidatedField(QFrame):
    ...
    def setup_ui(self, label: str, placeholder: str):
        ...
        self.required_mark.setStyleSheet("""
            font-size: 13px;
            font-weight: 700;
            color: #EF4444;
            background: transparent;
    ...
    def set_state(self, state: ValidationState, message: str = ""):
        ...
        if state == ValidationState.VALID:
            ...
            self.state_icon.setStyleSheet("color: #10B981;")
        elif state == ValidationState.INVALID:
            self.state_icon.setText("❌")
            self.state_icon.setStyleSheet("color: #EF4444;")
        elif state == ValidationState.WARNING:
            self.state_icon.setText("⚠️")
            self.state_icon.setStyleSheet("color: #F59E0B;")
        else:
            self.state_icon.setText("")
...
class SettingsTab(QWidget):
    ...
    def init_ui(self):
        ...
        # === Карточка Telegram ===
        self.telegram_card = SettingCard("Telegram интеграция", "📱")
        ...
        self.advanced_card = SettingCard("Дополнительно", "⚙️")
    ...
    def setup_telegram_section(self):
        ...
        info_icon = QLabel("ℹ️")
        info_icon.setStyleSheet("font-size: 18px; background: transparent;")
    ...
    def setup_notifications_section(self):
        ...
        self.notify_check.setStyleSheet("""
            QCheckBox {
                color: #E8F0FE;
                font-size: 14px;
                spacing: 8px;
    ...
    def setup_advanced_section(self):
        ...
        autosave_label.setStyleSheet("color: #E8F0FE; font-size: 13px;")
    ...
    def setup_save_panel(self):
        ...
        save_panel.setGraphicsEffect(shadow)
    ...
    def reset_changes(self):
        ...
        if reply == QMessageBox.StandardButton.Yes:
            ...
            self.status_label.setStyleSheet("color: #93A5C1;")
