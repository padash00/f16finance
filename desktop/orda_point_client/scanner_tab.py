...
class ScannerCard(QFrame):
    ...
    def __init__(self, parent=None):
        ...
        self.last_scan_container.setStyleSheet("""
            QFrame {
                background: #1A2332;
        ...
        self.last_scan_icon.setStyleSheet("font-size: 16px;")
        
        self.last_scan_label = QLabel("Последний товар: —")
        self.last_scan_label.setStyleSheet("font-size: 13px; color: #10B981;")
...
class ScannerForm(QGroupBox):
    ...
    def setup_ui(self):
        ...
        operator_label.setStyleSheet("font-size: 13px; font-weight: 600; color: #3B82F6;")
        ...
        self.operator_box.setStyleSheet("""
            QComboBox {
                background: #1A2332;
                border: 1px solid #2D3A4F;
                border-radius: 10px;
        ...
        barcode_label.setStyleSheet("font-size: 13px; font-weight: 600; color: #3B82F6;")
        ...
        product_label.setStyleSheet("font-size: 13px; font-weight: 600; color: #3B82F6;")
        ...
        qty_label.setStyleSheet("font-size: 13px; font-weight: 600; color: #3B82F6;")
        ...
        price_label.setStyleSheet("font-size: 13px; font-weight: 600; color: #3B82F6;")
    ...
    def set_operators(self, operators: List[Dict], current_id: Optional[str] = None):
        ...
        # Опция ручного ввода
        self.operator_box.addItem("✍️ Ручной ввод", None)
...
class ScannerTab(QWidget):
    ...
    def init_ui(self):
        ...
        self.scan_count_card.setStyleSheet("""
            QFrame {
                background: #0F172A;
                border: 1px solid #1E2A3A;
                border-radius: 12px;
        ...
        scan_icon = QLabel("📷")
        scan_icon.setStyleSheet("font-size: 20px;")
        
        self.scan_count_label = QLabel("0 сканирований")
        self.scan_count_label.setStyleSheet("font-size: 14px; font-weight: 600; color: #3B82F6;")
        ...
        self.total_amount_card.setStyleSheet("""
            QFrame {
                background: #0F172A;
                border: 1px solid #1E2A3A;
                border-radius: 12px;
        ...
        amount_icon = QLabel("💰")
        amount_icon.setStyleSheet("font-size: 20px;")
        
        self.total_amount_label = QLabel("0 ₸")
        self.total_amount_label.setStyleSheet("font-size: 14px; font-weight: 600; color: #F59E0B;")
        ...
        self.scanner_mode_btn.setStyleSheet("""
            QPushButton {
                background: #3B82F6;
                color: white;
                border: none;
        ...
        self.manual_mode_btn = QPushButton("✍️ Ручной")
