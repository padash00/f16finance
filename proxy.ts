...
export async function proxy(request: NextRequest) {
  ...
  const STORE_MERGE_REDIRECTS: Record<string, string> = {
    ...
    '/sales-monitor': '/store/sales',
    '/store/abc': '/store/sales',
    '/store/forecast': '/store/sales',
    '/store/analytics': '/store/sales',
  ...
  const PUBLIC_MARKETING = ['/offer', '/help', '/privacy', '/terms', '/sla', '/cookies', '/club-management-system', '/operator-salary-system', '/profit-and-loss-ebitda', '/point-terminal']
