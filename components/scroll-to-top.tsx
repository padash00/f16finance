...
export function ScrollToTop() {
  ...
  return (
    <button
      ...
      className="fixed bottom-20 right-4 z-40 grid h-11 w-11 place-items-center rounded-full border border-border bg-white/90 text-foreground shadow-lg backdrop-blur transition hover:bg-white dark:bg-slate-900/90 dark:hover:bg-slate-900 sm:bottom-6 sm:right-6"
    >
