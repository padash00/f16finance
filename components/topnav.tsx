  ...
  return (
    <Link
      ...
      className={cn(
        ...
        active
          ? 'bg-gradient-to-r from-amber-500/10 to-orange-500/10 text-slate-900 dark:text-white'
    ...
    >
      ...
      <div className="min-w-0 flex-1">
        <div className="flex items-center gap-2">
          <span className={cn('truncate text-sm font-medium', active ? 'text-slate-900 dark:text-white' : 'text-slate-700 group-hover:text-slate-900 dark:text-slate-200 dark:group-hover:text-white')}>
            {item.label}
          </span>
          {item.badge ? (
    ...
    >
      <button
        ...
        className={cn(
          ...
          active
            ? cn('text-slate-900 dark:text-white', style.bg, 'border', style.border)
    ...
    <div ref={ref} className="relative">
      ...
      >
        ...
        <div className="hidden min-w-0 max-w-[140px] lg:block">
          <p className="truncate text-xs font-semibold text-slate-900 dark:text-white">{displayName || 'Панель'}</p>
      ...
      <header className="sticky top-0 z-40 hidden border-b border-slate-200 bg-white/90 dark:border-white/5 dark:bg-slate-950/90 backdrop-blur-xl md:block">
        <div className="flex h-14 items-center gap-3 px-4 xl:px-6">
          ...
          <button
            ...
            className="flex items-center gap-2 rounded-xl border border-slate-200 bg-white dark:border-white/10 dark:bg-slate-900/70 px-3 py-1.5 text-xs text-slate-500 dark:text-slate-400 transition hover:border-amber-500/20 hover:text-slate-900 dark:hover:text-white"
          >
