...
export const navSections: NavSection[] = [
  ...
  },
  {
    ...
    items: [
      ...
      { href: '/sales-kpi/payout', label: 'Доплата продавцам', icon: Wallet, note: 'Кому сколько доплатить за качество работы', badge: 'new', badgeColor: 'green', isNew: true, feature: 'addon.sales_kpi' },
      { href: '/sales-kpi', label: 'Эффективность продавцов', icon: Gauge, note: 'Спрос или продавец: честный разбор смены', badge: 'new', badgeColor: 'green', isNew: true, feature: 'addon.sales_kpi' },
