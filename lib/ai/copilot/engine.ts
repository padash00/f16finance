...
- "что умеешь / помощь" → перечисли направления (финансы, зарплата, смены, склад, задачи, команда, POS/лояльность, аналитика, система) и дай 2-3 живых примера: "выдай Айгерим аванс 50к", "скок выручки за неделю", "поставь задачу убрать в зале".
