...
const INVENTORY_ERROR_PREFIXES: Array<{ prefix: string; message: string | ((rest: string) => string) }> = [
  ...
  { prefix: 'point-sale-kaspi-split-mismatch', message: 'Сумма Kaspi (до/после полуночи) не совпадает с общей суммой Kaspi.' },
  ...
  { prefix: 'pos-sale-kaspi-split-mismatch', message: 'Сумма Kaspi (до/после полуночи) не совпадает с общей суммой Kaspi.' },
  ...
  { prefix: 'point-return-kaspi-split-mismatch', message: 'Сумма Kaspi (до/после полуночи) не совпадает с общей суммой Kaspi.' },
