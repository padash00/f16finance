 ...
 *
 *   50%  историческая сезонность  — чем этот месяц был в прошлом
 *   25%  недавний тренд           — как идут дела последние недели
 *   15%  учебный контекст         — семестр, каникулы, сессия
 *   10%  состав календаря         — сколько в месяце выходных и праздников
 *
...
const WEIGHTS = {
  historical_seasonality: 0.5,
  recent_trend: 0.25,
  academic_context: 0.15,
  calendar_composition: 0.1,
} as const
