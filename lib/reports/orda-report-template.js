...
.exp-grid.c2{display:grid;grid-template-columns:minmax(0,1fr) minmax(0,1fr);column-gap:16px;align-content:start;}
.exp-grid.c3{display:grid;grid-template-columns:repeat(3,minmax(0,1fr));column-gap:14px;align-content:start;}
.exp{padding:3px 0 4px;border-bottom:1px solid #f4f7fa;min-width:0;}
