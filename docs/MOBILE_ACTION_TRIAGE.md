...
Всего: **270**. На телефон просятся **34**, работа за столом — **107**, спорных — **129**.
...
| Витрина | Перенос со склада на витрину | `store-showcase.move` | medium |
| Витрина | Возврат с витрины на склад | `store-showcase.return_to_warehouse` | medium |
...
| Долги точек | Отметить как оплачено | `point-debts.mark_paid` | high |
...
| Клиенты | Создание | `customers.create` | medium |
