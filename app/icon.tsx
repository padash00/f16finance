    ...
    (
      ...
      >
        <svg width="64" height="64" viewBox="0 0 64 64" fill="none">
          <defs>
            <linearGradient id="strokeGold" x1="8" y1="4" x2="54" y2="60" gradientUnits="userSpaceOnUse">
              <stop stopColor="#FFF2AA" />
              <stop offset="0.45" stopColor="#EEC94A" />
              <stop offset="1" stopColor="#8D6200" />
            </linearGradient>
            <linearGradient id="fillGold" x1="20" y1="22" x2="45" y2="46" gradientUnits="userSpaceOnUse">
              <stop stopColor="#FCE27A" />
              <stop offset="1" stopColor="#D39E10" />
            </linearGradient>
          </defs>

          <circle cx="32" cy="32" r="24.5" stroke="url(#strokeGold)" strokeWidth="2.2" />
          ...
          <rect x="21" y="36" width="4.2" height="9" rx="1" fill="url(#fillGold)" />
          <rect x="28.6" y="31.5" width="4.2" height="13.5" rx="1" fill="url(#fillGold)" />
          <rect x="36.2" y="26.5" width="4.2" height="18.5" rx="1" fill="url(#fillGold)" />
