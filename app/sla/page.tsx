          ...
          <article className="max-w-3xl space-y-8 text-slate-200">
            <header>
              ...
              <p className="mt-4 text-sm leading-7 text-slate-400">
                ...
                {' '}<Link href="/offer" className="text-amber-200 hover:underline">публичной оферты</Link>.
              </p>
            ...
            <section id="availability">
              <h2 className="text-2xl font-semibold tracking-tight text-white">2. Уровень доступности Сервиса</h2>
              <div className="mt-4 space-y-3 text-sm leading-7">
                <p><strong>2.1.</strong> Целевой уровень доступности веб-приложения и API Сервиса — <strong className="text-white">99,0 % в течение календарного месяца</strong> (без учёта плановых работ и обстоятельств, перечисленных в разделе 7).</p>
            ...
            <section id="maintenance">
              <h2 className="text-2xl font-semibold tracking-tight text-white">3. Плановые работы</h2>
              <div className="mt-4 space-y-3 text-sm leading-7">
            ...
            <section id="support">
              <h2 className="text-2xl font-semibold tracking-tight text-white">4. Техническая поддержка</h2>
              <div className="mt-4 space-y-3 text-sm leading-7">
                <p><strong>4.1.</strong> Техническая поддержка Заказчиков осуществляется через email <strong className="text-white">{LEGAL_ENTITY.emailSupport}</strong>.</p>
            ...
            <section id="response">
              <h2 className="text-2xl font-semibold tracking-tight text-white">5. Время реакции и приоритеты</h2>
              <div className="mt-4 space-y-3 text-sm leading-7">
                ...
                <div className="space-y-2">
                  <div className="rounded-xl border border-rose-400/20 bg-rose-400/5 p-4">
                    <div className="font-semibold text-rose-100">Критический</div>
                    <div className="text-xs text-slate-400">Сервис полностью недоступен или функция кассы Operator Desktop неработоспособна для всех точек Заказчика. Время первичной реакции — до 2 (двух) часов в рабочее время; время устранения зависит от причины и привлечённых обработчиков.</div>
                  </div>
                  <div className="rounded-xl border border-amber-400/20 bg-amber-400/5 p-4">
                    <div className="font-semibold text-amber-100">Высокий</div>
                    <div className="text-xs text-slate-400">Существенно нарушена работа отдельной функции или ограниченного числа точек. Время первичной реакции — до 8 (восьми) часов в рабочее время.</div>
                  </div>
                  <div className="rounded-xl border border-sky-400/20 bg-sky-400/5 p-4">
                    <div className="font-semibold text-sky-100">Средний</div>
                    <div className="text-xs text-slate-400">Незначительные ошибки, неудобства использования, вопросы по функциональности. Время первичной реакции — до 1 (одного) рабочего дня.</div>
                  </div>
                  <div className="rounded-xl border border-white/10 bg-white/5 p-4">
                    <div className="font-semibold text-white">Низкий</div>
                    <div className="text-xs text-slate-400">Пожелания по развитию, косметические замечания, вопросы общего характера. Время первичной реакции — до 3 (трёх) рабочих дней.</div>
                  </div>
                </div>
            ...
            <section id="offline">
              <h2 className="text-2xl font-semibold tracking-tight text-white">6. Работа Operator Desktop без интернета</h2>
              <div className="mt-4 space-y-3 text-sm leading-7">
                <p><strong>6.1.</strong> Operator Desktop поддерживает <strong className="text-white">частичную</strong> работу без интернет-соединения. Локально на устройстве оператора сохраняются и выполняются:</p>
                ...
                <p><strong>6.2.</strong> Без интернет-соединения <strong className="text-white">недоступны</strong>: загрузка документов и файлов, AI/OCR-функции, отправка Telegram-уведомлений, аналитические отчёты, синхронизация справочника товаров с сервера, обновление прав и ролей.</p>
            ...
            <section id="exclusions">
              <h2 className="text-2xl font-semibold tracking-tight text-white">7. Исключения и зависимости</h2>
              <div className="mt-4 space-y-3 text-sm leading-7">
            ...
            <section id="backup">
              <h2 className="text-2xl font-semibold tracking-tight text-white">8. Резервное копирование</h2>
              <div className="mt-4 space-y-3 text-sm leading-7">
            ...
            <section id="export">
              <h2 className="text-2xl font-semibold tracking-tight text-white">9. Выгрузка данных</h2>
              <div className="mt-4 space-y-3 text-sm leading-7">
            ...
            <section id="compensation">
              <h2 className="text-2xl font-semibold tracking-tight text-white">10. Компенсации</h2>
              <div className="mt-4 space-y-3 text-sm leading-7">
            ...
            <section id="changes">
              <h2 className="text-2xl font-semibold tracking-tight text-white">11. Изменения SLA</h2>
              <div className="mt-4 space-y-3 text-sm leading-7">
            ...
            <section id="contacts">
              <h2 className="text-2xl font-semibold tracking-tight text-white">12. Контакты</h2>
              <div className="mt-4 rounded-2xl border border-white/10 bg-white/5 p-5 text-sm leading-7">
                <div className="grid gap-2 text-slate-300">
                  <div><strong className="text-white">Исполнитель:</strong> {LEGAL_ENTITY.fullName}</div>
                  <div><strong className="text-white">Поддержка:</strong> {LEGAL_ENTITY.emailSupport}</div>
            ...
            <section id="history">
              <h2 className="text-2xl font-semibold tracking-tight text-white">13. История редакций</h2>
