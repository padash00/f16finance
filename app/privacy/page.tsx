          ...
          <article className="max-w-3xl space-y-8 text-[#475569]">
            ...
            <section id="rights">
              ...
              <div className="mt-4 space-y-3 text-sm leading-7">
                ...
                <p className="pt-2"><strong>11.1. Удаление учётной записи из мобильного приложения.</strong> Пользователь мобильного приложения Orda для iPhone и iPad может удалить свою учётную запись самостоятельно, без обращения в поддержку: «Аккаунт» → «Удалить аккаунт». Запрос выполняется немедленно.</p>
                <p><strong>11.2. Что удаляется.</strong> Учётная запись и возможность входа; контактные данные — номер телефона, адрес электронной почты, идентификатор Telegram; токены push-уведомлений устройства.</p>
                <p><strong>11.3. Что сохраняется и почему.</strong> Записи хозяйственной деятельности — смены, выручка, кассовые операции, зарплатные ведомости, акты склада и журналы аудита — остаются у Заказчика как собственника этих данных. Они относятся к деятельности точки продаж, а не к учётной записи, и их удаление сделало бы невозможным бухгалтерский и налоговый учёт, а также затронуло бы права других лиц. Такие записи хранятся в сроки, указанные в разделе 13, после чего удаляются или обезличиваются.</p>
                <p><strong>11.4. Уведомление владельца.</strong> О самостоятельном удалении учётной записи сотрудника или оператора владелец организации получает уведомление, а факт удаления фиксируется в журнале аудита: доступ к рабочим системам точки затрагивает других людей.</p>
                <p><strong>11.5. Ограничение.</strong> Учётная запись единственного владельца организации не может быть удалена из приложения: это лишило бы доступа всех сотрудников организации. Для такого удаления необходимо предварительно передать права владельца другому лицу или направить запрос на {LEGAL_ENTITY.emailSupport}.</p>
              </div>
            </section>
