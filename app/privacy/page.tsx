          ...
          <article className="max-w-3xl space-y-8 text-slate-200">
            ...
            <section id="definitions">
              ...
              <div className="mt-4 space-y-3 text-sm leading-7">
                ...
                <p>
                  <strong className="text-white">Компания</strong> — лицо,
                  осуществляющее сбор, обработку и защиту персональных данных
                  при оказании услуг Сервиса (в терминологии Закона РК
                  «О персональных данных» — оператор персональных данных).
                  Реквизиты Компании указаны в разделе&nbsp;3.
                </p>
                <p className="rounded-xl border border-slate-500/20 bg-slate-500/5 p-3 text-slate-300">
                  <strong className="text-white">Важное пояснение по терминологии.</strong>{' '}
                  В Сервисе{' '}«{SITE_NAME}» словом «оператор» (со строчной
                  буквы) называется сотрудник Заказчика, работающий за
                  кассой/администратор клуба. Это{' '}<em>не</em>{' '}«оператор
                  персональных данных» в смысле закона. Чтобы избежать
                  двусмысленности, в настоящей Политике юридический термин
                  «Оператор персональных данных» заменён на «Компания», а
                  слово «оператор» применяется только к сотруднику Заказчика.
                </p>
                <p>
            ...
            <section id="operator">
              ...
              <div className="mt-4 space-y-3 text-sm leading-7">
                <p>
                  <strong>3.1.</strong> Компанией, осуществляющей обработку
                  персональных данных при оказании услуг Сервиса, является:
                </p>
                <div className="mt-2 rounded-2xl border border-amber-400/20 bg-amber-400/5 p-5 text-sm">
                  <p className="text-amber-100">
                    <strong>Внимание:</strong> заполните реквизиты Компании перед
                    публикацией.
                  </p>
                ...
                <p>
                  <strong>3.2.</strong> В отношении данных, которые Заказчик
                  самостоятельно загружает в Сервис (данные о своих сотрудниках,
                  клиентах, поставщиках и т.д.), оператором персональных данных
                  по смыслу Закона РК является сам Заказчик. Компания в отношении
                  таких данных выступает Уполномоченным обработчиком и действует
                  по поручению Заказчика в пределах, необходимых для оказания
                  услуг Сервиса.
                </p>
                <p>
            ...
            <section id="legal">
              ...
              <div className="mt-4 space-y-3 text-sm leading-7">
                ...
                <ul className="ml-6 list-disc space-y-1.5 text-slate-300">
                  ...
                  <li>защита законных интересов Компании и (или) третьих лиц.</li>
                </ul>
              </div>
            </section>
            ...
            <section id="storage">
              ...
              <div className="mt-4 space-y-3 text-sm leading-7">
                <p>
                  <strong>7.1.</strong> Компания обеспечивает защиту персональных
                ...
                <ul className="ml-6 list-disc space-y-1.5 text-slate-300">
                  ...
                  <li>обучение персонала Компании правилам обработки персональных данных.</li>
                </ul>
                <p>
            ...
            <section id="transfer">
              ...
              <div className="mt-4 space-y-3 text-sm leading-7">
                <p>
                  <strong>8.1.</strong> Компания не передаёт персональные данные
            ...
            <section id="rights">
              ...
              <div className="mt-4 space-y-3 text-sm leading-7">
                ...
                <ul className="ml-6 list-disc space-y-1.5 text-slate-300">
                  ...
                  <li>обжаловать действия или бездействие Компании в уполномоченный орган в области защиты персональных данных Республики Казахстан или в суд.</li>
                </ul>
                <p>
                  <strong>11.2.</strong> Запросы и обращения по реализации прав
                  направляются на адрес электронной почты Компании (раздел 14)
            ...
            <section id="children">
              ...
              <div className="mt-4 space-y-3 text-sm leading-7">
                <p>
                  ...
                  лицами, не достигшими 18 (восемнадцати) лет. Компания не
            ...
            <section id="changes">
              ...
              <div className="mt-4 space-y-3 text-sm leading-7">
                <p>
                  <strong>13.1.</strong> Компания оставляет за собой право
              ...
              <div className="mt-4 space-y-3 text-sm leading-7">
                ...
                <div className="rounded-2xl border border-amber-400/20 bg-amber-400/5 p-5 text-sm">
                  ...
                  <p className="mt-3 text-amber-100">
                    ...
                    реквизиты Компании и контактные данные перед публикацией.
                  </p>
                </div>
                <p>
