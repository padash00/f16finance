        ...
        {loading ? (
          ...
          <div className="space-y-3">
            {companies.map((c) => {
              ...
              return (
                <div key={c.id} className="flex flex-col gap-2 rounded-xl border border-border bg-white dark:bg-white/[0.02] p-3 sm:flex-row sm:items-center sm:justify-between">
                  <div>
