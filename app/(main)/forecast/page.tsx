              ...
              <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                {(() => {
                  ...
                  return [
                    ...
                    { label: '60 дней', sublabel: 'прогноз', income: proj.week8Income, expense: proj.week8Expense, color: 'amber' },
                    { label: '90 дней', sublabel: 'прогноз', income: proj.week13Income, expense: proj.week13Expense, color: 'amber' },
                  ]
                    ...
                    <Card key={label} className="p-5 bg-white dark:bg-slate-900/80 border-border">
                      ...
                      <div className="space-y-2">
                        ...
                        <div className="border-t border-slate-200 dark:border-slate-800 pt-2 flex items-center justify-between">
                          ...
                          <span className={`text-base font-bold ${profit >= 0 ? 'text-amber-400' : 'text-red-400'}`}>
                      ...
                      return (
                        <div key={m.label} className="rounded-xl border border-slate-200 dark:border-slate-800 bg-slate-50 dark:bg-slate-900/50 p-4">
                          ...
                          <div className="flex items-center gap-2 text-xs">
                            ...
                            <span className="text-slate-500">vs пред. 30д ({fmtMoney(m.prev)})</span>
                          </div>
                        </div>
                      )
                    })}
                ...
                <Card className="p-5 bg-white dark:bg-slate-900/80 border-slate-200 dark:border-slate-800">
                  ...
                  <div className="space-y-2">
                    {result.categories.map((c) => {
                      ...
                      const arrowColor = Math.abs(trend) < 10 ? 'text-slate-400' : trend > 0 ? 'text-red-400' : 'text-emerald-400'
                      ...
                      return (
                        <div key={c.category} className="space-y-1">
                          ...
                          <p className="text-xs text-slate-500">{c.count} операций</p>
                        </div>
                      )
                    })}
                  </div>
                            ...
                            <div
                              className={`w-full rounded-t transition-all ${
                                isBest ? 'bg-gradient-to-t from-emerald-500 to-emerald-300'
                                  ...
                                  : 'bg-gradient-to-t from-amber-500/80 to-amber-400/80'
                              }`}
