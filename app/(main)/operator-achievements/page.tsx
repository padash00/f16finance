  ...
  return (
    <div className="app-page-wide space-y-6">
      ...
      <AdminPageHeader
        ...
        actions={
          <>
            <div className="flex items-center gap-1 bg-white/50 dark:bg-zinc-900/50 p-1 rounded-xl border border-slate-200 dark:border-white/10">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-3">
            {computed.map(({ row, rank, earned }) => (
              <button
                ...
                className="text-left rounded-2xl border border-slate-200 dark:border-white/10 bg-white dark:bg-slate-900/60 p-4 transition hover:border-amber-400/30 hover:bg-slate-50 dark:hover:bg-slate-900/80"
              >
                <div className="flex items-center gap-3">
                  <div className="flex h-10 w-10 shrink-0 items-center justify-center rounded-full border border-slate-200 dark:border-white/10 bg-gradient-to-br from-amber-100 to-amber-200 dark:from-amber-500/30 dark:to-amber-600/30 overflow-hidden">
                    {row.photo_url ? (
  ...
  return createPortal(
    ...
    >
      <div
        ...
        className="bg-white dark:bg-slate-900 border border-slate-200 dark:border-white/10 rounded-2xl w-full max-w-3xl my-8 animate-in fade-in zoom-in duration-200"
      >
        {/* Header */}
        <div className="sticky top-0 bg-white dark:bg-slate-900 border-b border-slate-200 dark:border-white/5 rounded-t-2xl z-10 p-5">
          <div className="flex items-center gap-4">
            <div className="flex h-14 w-14 shrink-0 items-center justify-center rounded-2xl border border-slate-200 dark:border-white/10 bg-gradient-to-br from-amber-100 to-amber-200 dark:from-amber-500/30 dark:to-amber-600/30 overflow-hidden">
              {row.photo_url ? (
  ...
  return (
    ...
    >
      <div className="flex items-start gap-3">
        ...
        <div className="min-w-0 flex-1">
          <div className={`text-sm font-semibold ${earned ? 'text-slate-900 dark:text-white' : 'text-slate-700 dark:text-slate-300'}`}>
            {ach.title}
          </div>
