...
const fallback = () => <div className="app-page-wide py-4"><PageSkeleton stats={6} rows={8} cols={6} /></div>
...
export default function StoreOrdersPage() {
  const [tab, setTab] = usePersistentState<Tab>('store.orders.tab', 'requests')
