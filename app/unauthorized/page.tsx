            ...
            <AlertDescription>
              <p>
                {isPlanLock
                  ...
                  : 'У вашей роли нет доступа к этой странице. Проверьте в какую организацию вы вошли и какая у вас должность. Если это ошибка — попросите владельца системы дать вам права на этой странице в разделе «Управление доступом».'}
              </p>
              {nextPath ? (
