-- Fix "column reference request_id is ambiguous" in inventory_decide_request.
-- Cause: output column name request_id (RETURNS TABLE) conflicted with unqualified
-- request_id references inside SQL statements.
