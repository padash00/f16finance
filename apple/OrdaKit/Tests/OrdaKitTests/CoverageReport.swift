...
struct CoverageReport {
    ...
    func report() {
        ...
        // Одиннадцать оставшихся — осознанные решения, а не долг:
        ...
        //   sales-kpi — владельческий разбор продавцов, экран впереди;
        //   operator-exams — назначение аттестации, у оператора свой экран
        //   сдачи.
        #expect(rest.count <= 11, "Охват уменьшился: было 11 незакрытых, стало \(rest.count)")
    }
}
