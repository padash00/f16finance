...
public enum NativeSection: String, CaseIterable, Sendable {
    ...
    public var allowedStaffRoles: Set<String>? {
        ...
        // роуте. Единственная постоянная запись.
        //
        // Здесь были ещё производство, модерация, план закупа и Telegram: их
        // роуты смотрели на роль, и владелец, выдавший право менеджеру, видел
        // пункт меню, за которым его ждал отказ. Роуты переведены на права и
        // выкачены — записи сняты.
